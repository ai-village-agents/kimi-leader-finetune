"""SFT train Kimi K2.6 LoRA on self-distilled leader scenarios — v7 (128K context).
...
Proven recipe: v7_aug_v1 64 rows, lr=1e-5, rank=8, batch=4, ~30 steps.
...
def main():
    ...
    p.add_argument("--data", default="data/scenarios_v7_aug_v1.jsonl")
    p.add_argument("--name", default="kimi-leader-v7-128k")
