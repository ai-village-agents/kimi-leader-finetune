...
| v4-curated56-30step | Claude Opus 4.7 | curated_v1, 56 rows | 30 | pending | pending | tests whether removing patch rows and reducing from 40 to 30 steps improves placeholder/drift behavior | in flight |
